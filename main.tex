...
\newglossaryentry{gnssfix}{
    name={GNSS fix},
    description={The desirable situation in which a connection to the satellite system is established, such that live localization information can be transmitted}
}

\newglossaryentry{sensorfusion}{
    name={sensor fusion},
    description={The process of combining information from multiple sensors, to augment the knowledge about the environment and increase the level of autonomy}
}
...
\newacronym{udp}{UDP}{Universal Datagram Protocol}
\newacronym{ptp}{PTP}{Precision Time Protocol}
\newacronym{imu}{IMU}{Intertial Measurement Unit}
\newacronym{dof}{DoF}{Degrees of Freedom}
\newacronym{gps}{GPS}{Global Positioning System}
\newacronym{glonass}{GLONASS}{Global Navigation Satellite System (Russian)}
\newacronym{rmse}{RMSE}{Root Mean Squared Error}
\newacronym{sfm2}{SfM}{Structure from Motion}
\newacronym{svd}{SVD}{Singular Value Decomposition}
\newacronym{ate}{ATE}{Absolute Trajectory Error}
\newacronym{cdf}{CDF}{Cumulative Distribution Function}
\newacronym{gicp}{GICP}{Generalized ICP}
\newacronym{rte}{RTE}{Relative Trajectory Error}
...
\newcommand{\reffigbr}[1]{(Fig.~\ref{fig:#1})}
\newcommand{\refch}[1]{(Chapter \ref{ch:#1})}

\hyphenation{time-stamp}
\hyphenation{encouraging}
...
\cftaddtitleline{toc}{chapter}{\acklabel}{}
...
{\setlength{\baselineskip}{0.3\baselineskip} % Adjust 0.9 to reduce spacing

...
\begin{algorithm}
	...
	\begin{algorithmic}[1] % number every line
		\State Set $\pose \leftarrow \tguess, P' \leftarrow \pose P$
		\For{$i=1, \dots, \iterth$}
		...
		\State $P' \leftarrow \pose'P'$ \Comment{Update the point cloud}

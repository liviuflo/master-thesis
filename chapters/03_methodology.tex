...
Filtering discards points with entropy above a certain percentile, to avoid a fixed threshold that would not be able to adjust to variable scene features. \reffig{sub-entr-log} Unfortunately, this is computationally expensive and does not visibly improve registration results.

...
\begin{figure}[h]
	\centering
	\subcaptionbox{Distribution of translation average errors.}{
		\includegraphics[width=0.45\linewidth]{images/pose_avg_trans_100s.pdf}
	}
	\hspace{1pt}
	\subcaptionbox{Distribution of rotation average errors..}{

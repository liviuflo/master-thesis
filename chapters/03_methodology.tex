...
This uncovers two possible evaluation directions, which also constitute the high-level aims of our method. On one hand, the output trajectory should match the actual path of the system as accurately as possible. On the other, the final map should not hide or damage small details in the scene, to obtain a high-quality 3D reconstruction. Both of these aspects will be analyzed thoroughly in Chapter \ref{ch:results}.

...
\begin{figure}[H]
    ...
    % }
    \caption[Map evaluation with and without GICP]{Map evaluation with and without GICP. Entropy and point-to-plane errors are lower, when GICP is used.}
...
\begin{table}[h!]
    ...
    {\small
        \begin{tabular}{c|ccccc|ccccc}
            ...
            \hline
            \hline
            0.05                    & 0.114                                         & 0.134                                       & 0.005                                & 0.007                                      & 0.002      & 0.029       & 0.032         & 0.003      & 0.005      & 0.000      \\
            0.1                     & 0.228                                         & 0.268                                       & 0.011                                & 0.014                                      & 0.009      & 0.058       & 0.067         & 0.003      & 0.005      & 0.001      \\

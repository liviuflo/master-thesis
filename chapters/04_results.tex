...
\begin{figure}[h]
    \centering
    \subcaptionbox{A curved region.}{
        \includegraphics[width=0.475\linewidth]{images/noisy_gps/curved.pdf}
    }
    \subcaptionbox{A corner region.}{
        \includegraphics[width=0.475\linewidth]{images/noisy_gps/corner.pdf}
    }
